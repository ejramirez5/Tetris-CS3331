...
import model.Tetromino;	import model.Tetromino;
import model.Tetromino.TetrominoEnum;	import model.Tetromino.TetrominoEnum;
import view.animation.AnimationApplet;	import view.animation.AnimationApplet;
...
//    public char[][] board = new char[21][11]; // maybe this isn't needed as can access the global instance of the board
    ...
    //sets background to a black to white gradiante and to the default size
    private void setBackground(Graphics g) {
    	int x= 0;
    	Color gradiante =new Color(x, x, x);
    	g.setColor(gradiante); // changed from bgColor
    	for( int i =0; i< dim.height; i+=5) {
    		g.fillRect(0, i, dim.width,5);
    		x+=1;
